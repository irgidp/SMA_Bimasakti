        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-5">
                    <h1 class="mt-5 bg-light">Edit Data Guru</h1>
                    <div class="row">
                        <?php
                    if (isset($_GET["nip"])) {
                        $db = dbConnect();
                        ...
                        ?>
                        <form method="post" name="frm" action="guruedit.php" onclick="validasidata()">
                            ...
                            <div class="col-md-12 py-2">
                                ...
                                <input type="text" id="nama_guru" name="nama_guru" class="form-control"
                                    value="<?php echo $dataguru["nama_guru"]; ?>">
                            </div>
                            ...
                            <div class="col-md-12 py-2">
                                ...
                                <select type="text" name="mata_pelajaran" id="mata_pelajaran" class="form-select">
                                    ...
                                    <option value="<?= $data['pelajaran'] ?>"
                                        <?php if ($data['pelajaran'] == $dataguru["mata_pelajaran"]) echo "selected"; ?>>
                                        <?= $data['pelajaran'] ?></option>
                                    <?php
                                    endwhile;
                                    ?>
                                </select>
                            ...
                            <div class="col-md-12 py-2">
                                ...
                                <input input type="text" name="password_guru" id="password_guru" class="form-control"
                                    value="<?php echo $dataguru["password_guru"]; ?>">
                            </div>
                            <?php
                                } else
