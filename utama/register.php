...
<head>
  ...
  <title>Bimasakti - Register</title>
            ...
            <div class="card-body">
              ...
              <form action="#!">
                <div class="form-group">
                  ...
                  <input type="email" name="email" id="email" class="form-control" placeholder="Nama Lengkap">
                </div>
                <div class="form-group">
                  <label for="email" class="sr-only">NIP</label>
                  <input type="email" name="email" id="email" class="form-control" placeholder="NIP">
                </div>
                <div class="form-group">
                  <label for="email" class="sr-only">Wali Kelas</label>
                  <input type="email" name="email" id="email" class="form-control" placeholder="Wali Kelas">
                </div>
